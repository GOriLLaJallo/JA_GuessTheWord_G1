 ...
 * gli errori infrastrutturali del database SQLite (come SQLException),
 * offrendo un feedback chiaro senza forzare la firma dei metodi con eccezioni controllate.
 * 
...
public class DataAccessException extends RuntimeException {
    ...
    /**
     * Costruisce una nuova DataAccessException con un messaggio descrittivo e la causa sottostante.
     * 
     * @param message il messaggio descrittivo dell'errore
